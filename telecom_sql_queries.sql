/* ============================================================
   ...
   PURPOSE : 15 Telecom SQL Analytics Queries
   DATABASE: Oracle SQL
...
DROP TABLE telecom_customer_usage PURGE;
...
/*
   OUTPUT (9 rows):
   +-----------+----------+-----------------+--------------------+------------------+------------------+------------------+
   | CITY      | PLAN_TYPE| TOTAL_CUSTOMERS | TOTAL_MONTHLY_BILL | AVG_MONTHLY_BILL | MIN_MONTHLY_BILL | MAX_MONTHLY_BILL |
   +-----------+----------+-----------------+--------------------+------------------+------------------+------------------+
   | Delhi     | Postpaid |               3 |            2597.00 |           865.67 |           799.00 |           899.00 |
   | Lucknow   | Postpaid |               2 |            1898.00 |           949.00 |           899.00 |           999.00 |
   | Delhi     | Prepaid  |               3 |            1148.00 |           382.67 |           299.00 |           450.00 |
   | Indore    | Postpaid |               1 |             999.00 |           999.00 |           999.00 |           999.00 |
   | Pune      | Postpaid |               1 |             799.00 |           799.00 |           799.00 |           799.00 |
   | Patna     | Postpaid |               1 |             699.00 |           699.00 |           699.00 |           699.00 |
   | Patna     | Prepaid  |               1 |             399.00 |           399.00 |           399.00 |           399.00 |
   | Kolkata   | Prepaid  |               1 |             399.00 |           399.00 |           399.00 |           399.00 |
   | Bangalore | Prepaid  |               1 |             350.00 |           350.00 |           350.00 |           350.00 |
   +-----------+----------+-----------------+--------------------+------------------+------------------+------------------+
*/
...
/*
   OUTPUT (3 rows):
   +-------------+--------+-------------------------+-----------------------+---------------------+------------------+----------------+
   | STATE       | CITY   | TOTAL_CHURNED_CUSTOMERS | TOTAL_RECHARGE_AMOUNT | AVG_RECHARGE_AMOUNT | TOTAL_COMPLAINTS | COMPLAINT_RATE |
   +-------------+--------+-------------------------+-----------------------+---------------------+------------------+----------------+
   | Maharashtra | Mumbai |                       3 |               1948.00 |              649.33 |                3 |           1.00 |
   | Delhi       | Delhi  |                       2 |                719.00 |              359.50 |                2 |           1.00 |
   | Rajasthan   | Jaipur |                       2 |                498.00 |              249.00 |                2 |           1.00 |
   +-------------+--------+-------------------------+-----------------------+---------------------+------------------+----------------+
*/
...
/*
   OUTPUT (1 row):
   +-------+------------------+---------------+------------------+------------------+
   | CITY  | AVG_CALL_MINUTES | TOTAL_RECORDS | MIN_CALL_MINUTES | MAX_CALL_MINUTES |
   +-------+------------------+---------------+------------------+------------------+
   | Patna |           380.00 |             2 |              310 |              450 |
   +-------+------------------+---------------+------------------+------------------+
*/
...
/*
   OUTPUT (7 rows):
   +-------------+----------+---------------+
   | STATE       | PLAN_TYPE| TOTAL_REVENUE |
   +-------------+----------+---------------+
   | Maharashtra | Postpaid |        5066.0 |
   | UP          | Postpaid |        2797.0 |
   | Delhi       | Postpaid |        2597.0 |
   | MP          | Postpaid |        1798.0 |
   | Bihar       | Postpaid |        1698.0 |
   | Delhi       | Prepaid  |        1568.0 |
   | Karnataka   | Prepaid  |        1090.0 |
   +-------------+----------+---------------+
*/
...
/*
   OUTPUT (3 rows):
   +-----------+--------------+-----------------+
   | CITY      | NETWORK_TYPE | TOTAL_COMPLAINTS|
   +-----------+--------------+-----------------+
   | Delhi     | 4G           |               4 |
   | Mumbai    | 5G           |               3 |
   | Bangalore | 4G           |               3 |
...
/*
   OUTPUT (3 rows):
   +-------------+--------------+-----------------+
   | STATE       | NETWORK_TYPE | TOTAL_DATA_USAGE|
   +-------------+--------------+-----------------+
   | Maharashtra | 5G           |           153.5 |
   | UP          | 5G           |            90.5 |
   | Delhi       | 5G           |            81.5 |
   +-------------+--------------+-----------------+
*/
...
/*
   OUTPUT (3 rows):
   +-------------+--------+--------------------+
   | STATE       | CITY   | TOTAL_CALL_MINUTES |
   +-------------+--------+--------------------+
   | Delhi       | Delhi  |               3820 |
   | Maharashtra | Mumbai |               3520 |
   | Bihar       | Patna  |               2410 |
   +-------------+--------+--------------------+
*/
...
/*
   OUTPUT (2 rows):
   +----------+-----------------------+
   | PLAN_TYPE| TOTAL_RECHARGE_AMOUNT |
   +----------+-----------------------+
   | Prepaid  |                5997.0 |
   | Postpaid |                4694.0 |
   +----------+-----------------------+
